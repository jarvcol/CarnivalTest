...
public class LoginModal extends PageObject {
    ...
    public static Target LOGIN_BUTTON = Target.the("Log in Modal Log in button").located(By.cssSelector("button.lrc-submit-button.cclr-button-secondary.cclr-button-small"));
    public static Target LOGIN_ERROR_MESSAGE = Target.the("Log in Modal Error Messages").located(By.cssSelector("ul.errf-list li"));
